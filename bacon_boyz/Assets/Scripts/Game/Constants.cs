...
{
	public const int GEM_AMOUNT_WIDTH = 8;
	public const int GEM_AMOUNT_HEIGHT = 10;
	...
	public const float DROP_GEMS_DURATION = 0.15f;
	public const float SHOOT_CANON_DURATION = 0.2f;
	...
	public const float INITIAL_SPAWN_DEALY = 15;
}
